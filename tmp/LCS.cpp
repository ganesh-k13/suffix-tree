...
int main(int argc, char *argv[])
{
    ...
    // size1 = 14;
    // printf("Longest Common Substring in GeeksforGeeks and Geeks is: ");
    // strcpy(text, "qeeksforGeeks#qqqqqqqqqqGeeksforGeeksforGeeksGeeksforGeeksGeeksforGeeksGeeksforGeeksGeeksforGeeksq$"); buildSuffixTree();
    // getLongestCommonSubstring();
    // //Free the dynamically allocated memory
    // freeSuffixTreeByPostOrder(root);
